        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
                  ...
                  <div id="button">
        <span style="float:right;"><a class="btn btn-warning" href="<?php echo site_url('admin/orders/print'); ?>"class="fa fa-print">Print</a>
        <span style="float:right;"><a class="btn btn-danger" href="<?php echo site_url('admin/orders/pdf'); ?>"class="fa fa-print">Export PDF</a><p>
