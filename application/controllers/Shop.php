...
class Shop extends CI_Controller {
    ...
    public function productkategori($id = 0)
    {
        if ($id == 0)
        {
            show_error('Akses tidak sah!');
        ...
        else
        {
                ...
                $product['related_products'] = $this->product->kategori_products($id);

                get_header('kategori' .' | '. get_settings('store_tagline'));
                get_template_part('shop/view_kategori', $product);
                get_footer();
